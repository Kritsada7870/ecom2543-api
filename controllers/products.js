...
// const { query } = require("../routes/products");
...
exports.remove = async (req, res) => {
  try {
    ...
    //Step 2 Promise ลบรูปภาพใน Cloud ลบแบบ รอด้วย
...
exports.listby = async (req, res) => {
  //คือการทำให้สินค้าเรียนตามลำดับ
  try {
...
exports.createImages = async (req, res) => {
  try {
    ...
    console.log(err)
    res.status(500).json({ message: "Servar Error" })
  }
}
